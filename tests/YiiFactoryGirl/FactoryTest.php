...
class FactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    //{
    //    $this->getInstance(array('connectionID' => 'migrate'), true)->getDbConnection();
    //}
     ...
     */
    private function getInstance(array $params = array(), $reset = false)
    {
        if ($reset) {
            $this->resetInstance();
        }
        if (!Yii::app()->hasComponent('factorygirl')) {
            Yii::app()->setComponent('factorygirl', array_merge(array('class' => 'YiiFactoryGirl\Factory'), $params));
        }
    ...
    {
        $reflection = new ReflectionObject($this->getInstance());
